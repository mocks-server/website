...
* Route variants can be defined in many ways, from [plain objects](./variants/json.md) to [plain text](./variants/text.md) or even [Express middlewares](./variants/middleware.md), and, depending on the variant type, they can act in different ways also, from sending a response to [proxy the request to another host](./variants/proxy.md).
...
:::tip
Read the next chapters to learn how to define each different variant type: [`json`](./variants/json.md), [`text`](./variants/text.md), [`middleware`](./variants/middleware.md) and [`proxy`](./variants/proxy.md).
:::
