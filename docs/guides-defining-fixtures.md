...
Read the [get started with fixtures chapter](get-started-routes.md) to know all possible fixtures properties.
:::
...
:::info Fixtures format
Read the [get started with behaviors chapter](get-started-mocks.md) to know all possible behaviors properties.
:::
