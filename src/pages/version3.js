...
const textContents = {
  ...
  easyToUse: `
    ...
    <br/><br/>
    Configure it using a configuration file, process arguments or environment variables. Use the [interactive CLI](docs/plugins-inquirer-cli) or the [admin REST API](docs/plugins-admin-api) for changing settings while it is running.
    <br/><br/>
